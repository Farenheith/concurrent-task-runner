...
export declare function mountClassDescribe(suite: (description: string, fn: () => void) => void): <Target, Class extends ClassOf<Target>>(cls: Class, bootStrap: () => Target, fn: (describe: MethodSuite<Target, Class>) => void) => void;
export declare function mountSructDescribe(suite: (description: string, fn: () => void) => void): <Target>(cls: Target, description: string, fn: (describe: StaticMethodSuite<Target>) => void) => void;
export declare function mountStaticClassDescribe(suite: (description: string, fn: () => void) => void): <Target, Class extends ClassOf<Target>>(cls: Class, fn: (describe: StaticMethodSuite<Class>) => void) => void;
/**
 ...
 */
export declare const describeStaticClass: DescribeStaticClass;
export declare const describeClass: DescribeClass;
export declare const describeStruct: DescribeStruct;
